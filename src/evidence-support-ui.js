...
function readinessLabel(readiness) {
  ...
  const labels = {
    "collecting-field-evidence": "0.8.0: kenttäevidenssiä kerätään",
    "field-evidence-needs-attention": "0.8.0: kenttäevidenssi tarkistettava",
    "awaiting-techstream": "0.8.0: odottaa Techstream-vertailua",
    "techstream-needs-attention": "0.8.0: Techstream-vertailu tarkistettava",
    "ready-for-release-review": "0.8.0: valmis julkaisu-review’hun"
  };
  return labels[status] || `0.8.0: ${status}`;
}
