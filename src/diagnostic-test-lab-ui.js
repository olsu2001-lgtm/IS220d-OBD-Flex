...
export function buildDiagnosticTestLabHtml({ coverage = null } = {}) {
  ...
  return `<details id="${ROOT_ID}" class="card simple-advanced test-lab-root" style="margin-top:16px">
    <summary><span><strong>Diagnostic Test Lab</strong><small>Tekninen signaali- ja testiputki</small></span></summary>
